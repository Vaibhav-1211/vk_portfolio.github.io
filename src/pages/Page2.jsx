      ...
      <div className="row g-2 justify-content-center text-start p-4">
        <div className="col-md-8">
          <div className="card-body  ">
            ...
            <div className='row-1'>
              <button className='btn btn-primary col rounded-pill my-3' type='button' ><a className="text-light text-decoration-none" href='https://drive.google.com/file/d/1OT6aAuFjTpGCbbu5SPqqs8lQdeIXY2PR/view?usp=sharing'>View Resume</a></button>
            </div>
          </div>
        </div>
      </div>
