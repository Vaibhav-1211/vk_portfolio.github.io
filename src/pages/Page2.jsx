      ...
      <div className="row g-2 justify-content-center text-start p-4">
        <div className="col-md-8">
          <div className="card-body  ">
            ...
            <div className='row-1'>
              <button className='btn btn-primary col rounded-pill my-3' type='button' ><a className="text-light text-decoration-none" href='https://docs.google.com/document/d/10rHwp5kuRj8Lk5zSeCIrJGldMW9GzS8v/edit?usp=sharing&ouid=111466538837725299315&rtpof=true&sd=true'>View Resume</a></button>
            </div>
          </div>
        </div>
      </div>
